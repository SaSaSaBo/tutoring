...
export class ConnectionController {
  ...
  async sendConnection(
    ...
    return this.connectionService.sendConnection(requester, requestee, sendData);
  }
  ...
  async acceptConnection(
    ...
    return this.connectionService.acceptConnection(requestee, requester, acceptData); 
  }
  ...
  async deleteConnection(
    ...
    const requester = await this.usersService.findOne(req.user.username);
    const requestee = await this.usersService.findOneById(id);
    return this.connectionService.deleteConnection(requester, requestee, deleteData);
  }
